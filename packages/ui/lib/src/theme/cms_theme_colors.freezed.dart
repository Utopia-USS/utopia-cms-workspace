...
mixin _$CmsThemeColors {
 ...
 Color get hint;/// Content (text / icon) colour used by components rendered on an
/// opt-in coloured / gradient background (e.g. `CmsSidebar`'s
...
/// coloured / gradient background (e.g. `CmsSidebar`'s
/// `backgroundColors` mode).
...
@override
String toString() {
  return 'CmsThemeColors(primary: $primary, accent: $accent, field: $field, canvas: $canvas, error: $error, disabled: $disabled, text: $text, surface: $surface, border: $border, rowAlt: $rowAlt, hover: $hover, chipBackground: $chipBackground, chipForeground: $chipForeground, hint: $hint, onColoredContent: $onColoredContent, onColoredSelected: $onColoredSelected, onColoredHover: $onColoredHover)';
}
