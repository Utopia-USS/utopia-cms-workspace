...
import 'package:utopia_cms_ui/src/widget/wrapper/cms_labeled_field.dart';

/// A single-select dropdown presented as a [CmsLabeledField] trigger with a
/// [CmsOverlayAnchor] popup listing [values], each rendered through
/// [valueLabelBuilder].
