...
class CmsWidgetItem with _$CmsWidgetItem {
  ...
  factory CmsWidgetItem.action({required Widget icon, required Widget title, required void Function() onPressed}) =
      CmsWidgetItemAction;

  factory CmsWidgetItem.custom({int? flex, @Default(SizedBox()) Widget child}) = CmsWidgetItemCustom;
