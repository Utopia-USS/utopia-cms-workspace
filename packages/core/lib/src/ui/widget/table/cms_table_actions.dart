...
class CmsTableActionsButton extends HookWidget {
  ...
  const CmsTableActionsButton({super.key, required this.value, required this.onUpdate, required this.actions});
  ...
  Widget build(BuildContext context) {
    ...
    return IgnorePointer(
      ...
      child: PopupMenuButton<CmsTableAction>(
        ...
        iconSize: 20,
        itemBuilder: (context) {
          return actions.map<PopupMenuEntry<CmsTableAction>>((e) {
